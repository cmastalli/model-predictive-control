...
The non-linear equations were linearized in order to be able to have a state space representation of the system to provide to the MPC software. The MPC strategy is calculating directly the control signals taking the 
