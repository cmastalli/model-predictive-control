...
std::string input_data_name_ = "../data/identification_input_data.txt";
std::string output_data_name_ = "../data/identification_output_data.txt";
...
void outputAngularPositionVelocityDataCallback(const ardrone_autonomy::Navdata& msg)
{
	...
	estimated_states_[3].push_back(msg.rotZ);
