...
void computeLTIModel(double* point_states_ptr, double* input_states_ptr)
{
	...
	A_(3,6) = (Cm*(u(0)+u(1)+u(2)+u(3)))*(sin(x(8))*cos(x(6)) - cos(x(8))*sin(x(7))*sin(x(6)));
	A_(3,7) = (Cm*(u(0)+u(1)+u(2)+u(3)))*(cos(x(8))*cos(x(7))*cos(x(6)));
	A_(3,8) = (Cm*(u(0)+u(1)+u(2)+u(3)))*(cos(x(8))*sin(x(6)) - sin(x(8))*sin(x(7))*cos(x(6)));
	A_(4,6) = -(Cm*(u(0)+u(1)+u(2)+u(3)))*(sin(x(8))*sin(x(7))*sin(x(6)) + cos(x(8))*cos(x(6)));
	A_(4,7) = (Cm*(u(0)+u(1)+u(2)+u(3)))*(sin(x(8))*cos(x(7))*cos(x(6)));
	A_(4,8) = (Cm*(u(0)+u(1)+u(2)+u(3)))*(cos(x(8))*sin(x(7))*cos(x(6)) + sin(x(8))*sin(x(6)));
	A_(5,6) = -(Cm*(u(0)+u(1)+u(2)+u(3)))*(cos(x(7))*sin(x(6)));
	A_(5,7) = -(Cm*(u(0)+u(1)+u(2)+u(3)))*(sin(x(7))*cos(x(6)));
	...
	A_(6,11) = cos(x(6))*tan(x(6));
	A_(7,8) = -x(10)*sin(x(6)) - x(11)*cos(x(6));
	A_(7,10) = cos(x(6));
	A_(7,11) = -sin(x(6));
	...
	A_(9,10) = (Iyy_ - Izz_)*(x(11)/Ixx_);
	A_(9,11) = (Iyy_ - Izz_)*(x(10)/Ixx_);
	A_(10,9) = (Izz_ - Ixx_)*(x(11)/Iyy_);
	...
	B_(3,0) = (cos(x(8))*sin(x(7))*cos(x(6)) + sin(x(8))*sin(x(6)))*Cm;
	B_(3,1) = (cos(x(8))*sin(x(7))*cos(x(6)) + sin(x(8))*sin(x(6)))*Cm;
	B_(3,2) = (cos(x(8))*sin(x(7))*cos(x(6)) + sin(x(8))*sin(x(6)))*Cm;
	B_(3,3) = (cos(x(8))*sin(x(7))*cos(x(6)) + sin(x(8))*sin(x(6)))*Cm;		

	B_(4,0) = (sin(x(8))*sin(x(7))*cos(x(6)) - cos(x(8))*sin(x(6)))*Cm;
	B_(4,1) = (sin(x(8))*sin(x(7))*cos(x(6)) - cos(x(8))*sin(x(6)))*Cm;
	B_(4,2) = (sin(x(8))*sin(x(7))*cos(x(6)) - cos(x(8))*sin(x(6)))*Cm;
	B_(4,3) = (sin(x(8))*sin(x(7))*cos(x(6)) - cos(x(8))*sin(x(6)))*Cm;
	
	B_(5,0) = (cos(x(8))*cos(x(6)))*Cm;
	B_(5,1) = (cos(x(8))*cos(x(6)))*Cm;
	B_(5,2) = (cos(x(8))*cos(x(6)))*Cm;
	B_(5,3) = (cos(x(8))*cos(x(6)))*Cm;

	B_(9,1) = (2*d*Ct_*u(1))/Ixx_;
	B_(9,3) = -(2*d*Ct_*u(3))/Ixx_;

	B_(10,0) = -(2*d*Ct_*u(0))/Iyy_;
	B_(10,2) = (2*d*Ct_*u(2))/Iyy_;
