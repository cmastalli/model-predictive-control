 ...
 */
	...
	public:
	     ...
	     */
	    ModelPredictiveControl(double infty = 1E19);
	     ...
	     */
	    void reset(OdeManager * odemanager, Optimization::XXX *minimizer, mpc::Model *model, int horizon, int precedesteps = 0, ModelShootingData *shootingdata = 0);
	    ...
	    /**
	     ...
	     @throw yane::Utils::MemoryException Is thrown if memory allocation failed
	     */
	    void allocateMemory(double* & t, double* &u );
	    ...
	    /**
	     ...
	     @throw yane::Utils::NotInitializedException Is thrown if the yane::MPC::MPC object is not yet defined, i.e. if the yane::MPC::MPC::reset function has not been called
	     */
	     void generateTimeGrid(double *t, double t_start, double h_new);
	      ...
	      */
	     void initMPCProblem(double * t, double * u0);
	      ...
	      */
	     void startMPCSolution(double *x, int realtimesteps = 0, double aborttimeoffset = 0.0, double abortSuboptimalityDegree = INFINITY);
	      ...
	      */
	     void resizeHorizon(int new_horizon, double h_new);
	     ...
	     /**
	      ...
	      @throw yane::Utils::Exception Is thrown if an other error occurs
	      */
	     void shiftHorizon(double *next_controls, double *next_timesteps, int m = 1, double *x = 0, double h_new = 0.0);
	     ...
	     /**
	      ...
	      @throw yane::Utils::ValueException Is thrown if input is errorneous
	      */
	     void setConfigShiftHorizon(T_SHIFTSTATE optimize = STANDARD, T_SHIFTRETURNDATA returndata = PREDICTED_DATA);
	     ...
	     /**
	      ...
	      @throw yane::Utils::Exception Is thrown if an other error occurs
	      */
	     void setInternalSimulatorPrecision(double rtol, double atol);
	      ...
	      */
	     void setShowSqpError(bool showSqpError);

	     /**
	      @brief Function to return the mpc::Model object used for optimization and prediction
	      @return Pointer the used mpc::Model::Model object
	...
	protected:
	    ...
	    Discretization *problem_;  /** @brief Pointer to used class yane::MPC::Discretization object */
	    Discretization *problem_shift_;  /** @brief Pointer to used class yane::MPC::Discretization object used within the yane::MPC::MPC::shiftHorizon method */

	    mpc::Optimization::XXX *minimizer_; /** @brief Pointer to used class yane::MinProg::NLP object */
	    mpc::OdeManager *odemanager_;  /** @brief Pointer to used class yane::MPC::OdeManager object */
	    mpc::Model *model_;  /** @brief Pointer to used class yane::Model::Model object */

	    mpc::Model::ModelShootingData *shootingdata_; /** @brief Pointer to used class yane::MPC::ModelShootingData object */

	    mpc::Model::Simulator *modelsim_; /** @brief Pointer to used class yane::Model::Simulator object */
