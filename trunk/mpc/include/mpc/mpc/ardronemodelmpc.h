#ifndef ARDRONEMODELMPC_QPOASES_H
#define ARDRONEMODELMPC_QPOASES_H
...
namespace mpc
{
     ...
     */
	class ArdroneModelMPC : public mpc::ModelPredictiveControl
	{

		public:
			/** @brief Constructor function */
			ArdroneModelMPC(ros::NodeHandle node_handle);
